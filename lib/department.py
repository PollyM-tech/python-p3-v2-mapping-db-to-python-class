...
# # Dictionary of objects saved to the database.
    ...
    def instance_from_db(cls, row):
        """return a department object having the attributes value from the table row"""
    ...
    def update(self):
        """Update the table row corresponding to the table row matching the specified primary key"""
        sql = """
            UPDATE departments
            SET name = ?, location = ?
            WHERE id = ?
